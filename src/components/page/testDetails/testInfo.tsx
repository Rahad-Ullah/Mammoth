  ...
  return (
    <ul className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <span>{test.patient.sensory_symptoms}</span>
      </li>
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <span>{test.cpts.map((item) => item).join(", ")}</span>
      </li>
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <span className="text-primary">{test.ordering_physician}</span>
      </li>
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <span className="text-zinc-400">ICD(s)</span>
        <span>{test.icds.map((item) => item).join(", ")}</span>
      </li>
      <li className="grid grid-cols-1 md:grid-cols-2 gap-4">
